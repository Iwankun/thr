...
Iya.addEventListener("click", function () {
  ...
  if (Iya.value == 1) {
    ...
    Text.innerHTML = "Halo, Saya Ridwan";
    ...
    void Text.offsetWidth;
    Text.innerHTML =
      "تَقَبَّلَ اللَّهُ مِنَّا وَمِنْكُمْ وَ تَقَبَّلْ ياَ كَرِيْمُ <br><br> Taqabbalallahu Minna Wa Minkum";
    Text.classList.add("text-animate");
  } else if (Iya.value == 8) {
    Image.setAttribute(
      "src",
    ...
    Image.setAttribute("src", "dana.jpg");
    Text.classList.remove("text-animate");
    void Text.offsetWidth;
